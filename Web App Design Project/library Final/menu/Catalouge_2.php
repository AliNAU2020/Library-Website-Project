			...
			<div>
				<?php  if (isset($_SESSION['user'])) : ?>
					...
					<small>
						...
						<br>
						<a href="Catalouge_2.php?logout='1'" style="color: red;">logout</a>
					</small>
...
<?php
$query = 'SELECT * FROM Book WHERE ID IN (11,12,13,14,15)';
...
<table align="center" style="text-align:center">
<?php
$query = 'SELECT * FROM Book WHERE ID IN (16,17,18,19,20)';
$result = mysqli_query($conn, $query);
$resultCheck = mysqli_num_rows($result);
